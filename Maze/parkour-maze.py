...
dossier = "H:\Documents\python\krunker-map"

m = open(dossier + "\Maze\maze_base.json", 'r')
...
data["name"] = "Maze_" + map_Name
data["welMsg"] = "Welcome to Maze_" + map_Name
...
for w in wall_list[0]: #vertical
    data['objects'].append({"p": [w[0] * cell_width, 0, w[1] * cell_width - cell_width/2],"t": 11, "ci": wall_color, "si": 29})
...
for w in wall_list[1]: #horizontal
    data['objects'].append({"p": [w[0] * cell_width - cell_width/2, 0, w[1] * cell_width - cell_width],"t": 11, "ci": wall_color, "si": 28})
...
for i in range(nb_towers):
    ...
    objects = [
        {"p":[x - 16, towers_height - 24,y - 16],"t":2,"ci":darkwood_color,"si":30},
        {"p":[x - 5, 0,y],"i":3,"t":2,"d":2,"si":31},
        {"p":[x + 5, 0,y],"i":3,"t":2,"si":31},
        {"p":[x, 0, y + 5],"i":3,"t":2,"d":1,"si":31},
        {"p":[x, 0, y - 5],"i":3,"t":2,"d":3,"si":31},
        {"p":[x, towers_height - 25, y + 15],"t":2,"ci":lightwood_color,"si":32},
        {"p":[x, towers_height - 25, y - 15],"t":2,"ci":lightwood_color,"si":32},
        {"p":[x - 15, towers_height - 25, y],"t":2,"ci":lightwood_color,"si":33},
        {"p":[x + 15, towers_height - 25, y],"t":2,"ci":lightwood_color,"si":33},
        {"p":[x, towers_height, y],"t":2,"ci":lightwood_color,"si":34},
        {"p":[x, 0, y],"t":2,"ci":darkwood_color,"si":35},
        {"p":[x - 16, towers_height - 24, y + 16],"t":2,"ci":darkwood_color,"si":30},
        {"p":[x + 16, towers_height - 24, y - 16],"t":2,"ci":darkwood_color,"si":30},
        {"p":[x + 16, towers_height - 24, y + 16],"t":2,"ci":darkwood_color,"si":30},
        {"p":[x, towers_height + 3, y],"t":2,"ci":lightwood_color,"si":36}
    ]
...
with open(f"{dossier}\maps\ParkourMaze\Maze_{map_Name}.json", "w") as m:
    json.dump(data, m)
    m.close()

print("Maze successfully generated")
print(f"number of objects : {str(objects_nbr)}")
image.save(f"{dossier}\maps\ParkourMaze\Maze_{map_Name}_thumb.png")
...
image.save(f"{dossier}\maps\ParkourMaze\Maze_{map_Name}_solved.png")